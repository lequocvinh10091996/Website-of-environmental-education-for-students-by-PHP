<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Những Tài Khoản</a></li>
        </ol>
            ...
            <div class="box-content no-padding">
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $dong['ho_ten_nguoi_dung']; ?></td>
                            <td><?php echo $dong['tai_khoan_nguoi_dung']; ?></td>
                            <td><?php echo $dong['mat_khau_nguoi_dung']; ?></td>
                            <td><?php echo $dong['loai_tai_khoan']; ?></td>
                            <td><a href="index_v1.php#ajax/quan_ly_tai_khoan.php?id_taikhoan=<?php echo $dong['id_quan_ly_tk']; ?>&sua=sua_taikhoan">Sửa</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_tai_khoan.php?id_taikhoan=<?php echo $dong['id_quan_ly_tk'] ?>&xoa=xoa_taikhoan">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
