			...
			<div class="box-header">
                ...
                <div class="box-content">
                    <?php if(isset($_GET['sua'])){?>
                        ...
                        <form action="ajax/xu_ly/xu_ly_quan_ly_giao_vien.php?id_giaovien=<?php echo $dong['id_quan_ly_gv'];?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group has-success has-feedback">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="chuyen_nganh_giao_vien" class="form-control" placeholder="Chức Vụ Giáo Viên" value="<?php echo $dong['chuyen_nganh_giao_vien']?>">
                                </div>
                            </div>
                            <div class="form-group has-success has-feedback">
                                <label class="col-sm-2 control-label">Trường Của Giáo Viên</label>
                                <div class="col-sm-4">
                                    <input type="text" name="truong_cua_giao_vien" class="form-control" placeholder="Trường Giáo Viên" value="<?php echo $dong['truong_cua_giao_vien']?>">
                                </div>
                            </div>
                            <div class="form-group">
