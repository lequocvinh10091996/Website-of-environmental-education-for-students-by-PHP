    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-content no-padding">
                ...
                $sql="select * from quan_ly_trang_thai_bai_kiem_tra_cuoi_khoa";
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $dong['ten_khoa_hoc']; ?></td>
                            <td><?php echo $dong['ho_ten_dang_ky']; ?></td>
                            <td><?php echo $dong['diem_kiem_tra_cuoi_khoa']; ?></td>
                            <td><?php echo $dong['trang_thai']; ?></td>
                            <td><a href="quiz/index_khoa_kiem_tra_ql.php?id_khoahoc_kiemtra=<?php echo $dong['id_quan_ly_kh'];?>">Xem</a></td>
                            <?php if($dong['trang_thai']=='hoàn thành'){?>
                                <td>Bài Kiểm Tra Đã Kết Thúc</td>
                            <?php }?>
                            <?php if($dong['trang_thai_duyet_kiem_tra']=='chưa duyệt'){?>
                                <td><a href="ajax/xu_ly/xu_ly_quan_ly_duyet_kiem_tra_khoa_hoc.php?id_khoahoc=<?php echo $dong['id_quan_ly_kh'] ?>&duyet_tdk=<?php echo $dong['ho_ten_dang_ky'] ?>">Duyệt</a></td>
                            <?php }?>
                            <?php if($dong['trang_thai_duyet_kiem_tra']=='đã duyệt' && $dong['trang_thai']=='chưa hoàn thành'){?>
                                <td><a>Đã Duyệt</a></td>
                            <?php }?>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_trang_thai_bai_kiem_tra_cuoi_khoa.php?id_ktck=<?php echo $dong['id_quan_ly_ktck'] ?>&xoa=xoa_ktck">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
