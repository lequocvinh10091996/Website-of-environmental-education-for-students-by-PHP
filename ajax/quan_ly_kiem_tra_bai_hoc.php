...
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#">Quản Lý Kiểm Tra Của Bài Học</a></li>
		</ol>
	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
            ...
            <?php if(isset($_GET['sua'])){?>
                <?php
                if(isset($_GET['id_kiemtra'])) {
                    session_start();
                    include('xu_ly/config/config.php');
                    $id_kiemtra = $_GET['id_kiemtra'];
                    $sql = "select * from quan_ly_kiem_tra_bai_hoc where id_quan_ly_ktbh='$id_kiemtra'";
                    $run = mysqli_query($conn, $sql);
                    $dong = mysqli_fetch_array($run);
                }
                ?>
                <div class="box-content">
                    <h4 class="page-header">Sửa Bài Kiểm Tra</h4>
                    <form action="ajax/xu_ly/xu_ly_quan_ly_kiem_tra_bai_hoc.php?id_kiemtra=<?php echo $dong['id_quan_ly_ktbh']; ?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        <div class="form-group has-success has-feedback">
                            <label class="col-sm-2 control-label"><h4>Mã Bài Học</h4></label> <label class="col-sm-2 control-label"><h4><?php echo $dong['id_quan_ly_bh']; ?></h4></label>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="form-styles">Hình ảnh</label>
                            <div class="col-sm-10">
                                <input type="file" name="hinh_ch">
                            </div>
                        </div>
                        <div class="form-group">
...
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Câu Hỏi 2</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_ch2" name="cau_hoi_2">--><?php //echo $dong['cau_hoi_2']; ?><!--</textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Trả Lời 1</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_1_ch2" name="tra_loi_1_ch2">--><?php //echo $dong['tra_loi_1_ch2']; ?><!--</textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Trả Lời 2</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_2_ch2" name="tra_loi_2_ch2">--><?php //echo $dong['tra_loi_2_ch2']; ?><!--</textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Trả Lời 3</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_3_ch2" name="tra_loi_3_ch2">--><?php //echo $dong['tra_loi_3_ch2']; ?><!--</textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Trả Lời 4</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_4_ch2" name="tra_loi_4_ch2">--><?php //echo $dong['tra_loi_4_ch2']; ?><!--</textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Trả Lời Đúng</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_dung_ch2" name="tra_loi_dung_ch2">--><?php //echo $dong['tra_loi_dung_ch2']; ?><!--</textarea>-->
<!--                            </div>-->
<!--                        </div>-->
                        <div class="clearfix"></div>
                        <div class="form-group">
                            <div class="col-sm-2">
                                <button type="submit" class="btn btn-primary btn-label-left" name="sua_bai_kiem_tra">
            ...
            <?php }else{?>
                ...
                if(isset($_GET['id_baihoc'])) {
                    ...
                    $run = mysqli_query($conn, $sql);
                    $dong = mysqli_fetch_array($run);
                    $_SESSION['id_baihoc'] = $dong['id_quan_ly_bh'];
                }
                ?>
                <div class="box-content">
                    <?php
                    $id_baihoc = $_GET['id_baihoc'];
                    $sql1 = "select count(*) from quan_ly_kiem_tra_bai_hoc where id_quan_ly_bh='$id_baihoc'";
                    ...
                    <form action="ajax/xu_ly/xu_ly_quan_ly_kiem_tra_bai_hoc.php" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        <div class="form-group has-success has-feedback">
                            <label class="col-sm-2 control-label"><h4>Mã Bài Học</h4></label> <label class="col-sm-2 control-label"><h4><?php echo $dong['id_quan_ly_bh']; ?></h4></label>
                        </div>
                        <div class="form-group">
...
<!--                            <label class="col-sm-2 control-label" for="form-styles">Câu Hỏi 2</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_ch2" name="cau_hoi_2"></textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Trả Lời 1</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_1_ch2" name="tra_loi_1_ch2"></textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Trả Lời 2</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_2_ch2" name="tra_loi_2_ch2"></textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Trả Lời 3</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_3_ch2" name="tra_loi_3_ch2"></textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Trả Lời 4</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_4_ch2" name="tra_loi_4_ch2"></textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="form-styles">Trả Lời Đúng</label>-->
<!--                            <div class="col-sm-10">-->
<!--                                <textarea class="form-control" rows="5" id="wysiwig_full_dung_ch2" name="tra_loi_dung_ch2"></textarea>-->
<!--                            </div>-->
<!--                        </div>-->
                        <div class="clearfix"></div>
                        <div class="form-group">
                            <div class="col-sm-2">
                                <button type="submit" class="btn btn-primary btn-label-left" name="them_bai_kiem_tra">
                                    <span><i class="fa fa-clock-o"></i></span>
                                    Submit
                                </button>
                            </div>
