<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#">Bảng</a></li>
			<li><a href="#">Bảng Những Khóa Học Của Giáo Viên</a></li>
		</ol>
	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					<i class="fa fa-usd"></i>
					<span>Những Khóa Học Của Giáo Viên</span>
				</div>
				<div class="box-icons">
...
<!--							<th>Country of Citizenship</th>-->
                    ...
                    ?>
						<tr>
							<td><?php echo $i; ?></td>
							<td><img class="img-rounded" src="ajax/xu_ly/uploads/lop_<?php echo $dong1['lop_khoa_hoc']; ?>/<?php echo $dong1['hinh_anh_khoa_hoc']; ?>" alt=""><?php echo $dong['ten_khoa_hoc']; ?></td>
							<td><?php echo $dong1['lop_khoa_hoc']; ?></td>
							<td><a href="index_v1_gv.php#ajax/quan_ly_bai_hoc_gv.php?id_khoahoc=<?php echo $dong1['id_quan_ly_kh']; ?>">Thêm Bài Học</a></td>
                            <td><a href="index_v1_gv.php#ajax/quan_ly_kiem_tra_khoa_hoc_gv.php?id_khoahoc=<?php echo $dong1['id_quan_ly_kh']; ?>&them_kt=them_kt">Thêm Kiểm Tra Cuối Khóa</a></td>
                            <td><a href="index_v1_gv.php#ajax/quan_ly_khoa_hoc_gv.php?id_khoahoc=<?php echo $dong1['id_quan_ly_kh']; ?>&sua=sua_khoahoc">Sửa</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_khoa_hoc_gv.php?id_khoahoc=<?php echo $dong1['id_quan_ly_kh'] ?>&xoa=xoa_khoahoc">Xóa</a></td>
<!--							<td>telecom</td>-->
<!--							<td>Mexico</td>-->
						</tr>
                        <?php
