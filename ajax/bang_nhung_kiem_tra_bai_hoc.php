    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-content no-padding">
                ...
                $sql="select * from quan_ly_kiem_tra_bai_hoc";
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            ...
                            <td><?php echo $dong['cau_hoi_1']; ?></td>
                            <td><?php echo $dong['tra_loi_dung_ch1']; ?></td>
                            <td><a href="index_v1.php#ajax/quan_ly_kiem_tra_bai_hoc.php?id_kiemtra=<?php echo $dong['id_quan_ly_ktbh']; ?>&sua=sua_kiemtra">Sửa</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_kiem_tra_bai_hoc.php?id_kiemtra=<?php echo $dong['id_quan_ly_ktbh'] ?>&xoa=xoa_kiemtra">Xóa</a></td>
                        </tr>
                        <?php
                        $i++;
                    }
