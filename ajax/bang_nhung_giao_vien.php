<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Những Giáo Viên</a></li>
        </ol>
            ...
            <div class="box-content no-padding">
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><img class="img-rounded" src="ajax/xu_ly/uploads/giao_vien/<?php echo $dong['hinh_anh_giao_vien']; ?>" alt=""><?php echo $dong['ten_giao_vien']; ?></td>
                            <td><?php echo $dong['chuyen_nganh_giao_vien']; ?></td>
                            <td><?php echo $dong['truong_cua_giao_vien']; ?></td>
                            <td><a href="index_v1.php#ajax/quan_ly_giao_vien.php?id_giaovien=<?php echo $dong['id_quan_ly_gv']; ?>&sua=sua_giaovien">Sửa</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_giao_vien.php?id_giaovien=<?php echo $dong['id_quan_ly_gv'] ?>&xoa=xoa_giaovien">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
