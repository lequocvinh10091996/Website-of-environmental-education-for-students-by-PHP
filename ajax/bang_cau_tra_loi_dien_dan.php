<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Câu Tra Lời Diễn Đàn</a></li>
        </ol>
            ...
            <div class="box-content no-padding">
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $dong['nguoi_tra_loi_dien_dan']; ?></td>
                            <td><?php echo $dong['cau_hoi_dien_dan']; ?></td>
                            <td><?php echo $dong['tra_loi_dien_dan']; ?></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_tra_loi_dien_dan.php?id_tldd=<?php echo $dong['id_quan_ly_tldd'] ?>&xoa=xoa_tldd">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
