<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#">Bảng</a></li>
			<li><a href="#">Bảng Những Khóa Học</a></li>
		</ol>
				...
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
					<thead>
						<tr>
                            ...
                            <th>Mã khóa học</th>
							<th>Khóa Học</th>
							<th>Lớp Của Khóa học</th>
                            <th>Loại khoá học</th>
							<th>Thêm Bài Học</th>
                            <th>Thêm Kiểm Tra Cuối Khóa</th>
                            <th></th>
                            <th></th>
<!--							<th>Source</th>-->
<!--							<th>Country of Citizenship</th>-->
                    ...
                    ?>
						<tr>
							...
							<td><img class="img-rounded" src="ajax/xu_ly/uploads/lop_<?php echo $dong['lop_khoa_hoc']; ?>/<?php echo $dong['hinh_anh_khoa_hoc']; ?>" alt=""><?php echo $dong['ten_khoa_hoc']; ?></td>
							<td><?php echo $dong['lop_khoa_hoc']; ?></td>
                            <td><?php echo $dong['loai_khoa_hoc']; ?></td>
							<td><a href="index_v1.php#ajax/quan_ly_bai_hoc.php?id_khoahoc=<?php echo $dong['id_quan_ly_kh']; ?>">Thêm Bài Học</a></td>
                            <td><a href="index_v1.php#ajax/quan_ly_kiem_tra_khoa_hoc.php?id_khoahoc=<?php echo $dong['id_quan_ly_kh']; ?>&them_kt=them_kt">Thêm Kiểm Tra Cuối Khóa</a></td>
                            <td><a href="index_v1.php#ajax/quan_ly_khoa_hoc.php?id_khoahoc=<?php echo $dong['id_quan_ly_kh']; ?>&sua=sua_khoahoc">Sửa</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_khoa_hoc.php?id_khoahoc=<?php echo $dong['id_quan_ly_kh'] ?>&xoa=xoa_khoahoc">Xóa</a></td>
<!--							<td>telecom</td>-->
<!--							<td>Mexico</td>-->
						</tr>
                        <?php
