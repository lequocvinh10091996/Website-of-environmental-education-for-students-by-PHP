...
if(isset($_GET['xoa'])){
    //xoa
    $id_chungnhan=$_GET['id_chungnhan'];

    $sql="delete from quan_ly_chung_nhan where id_quan_ly_cn='$id_chungnhan'";
    mysqli_query($conn,$sql);
    header('location:../../index_v1.php#ajax/bang_nhung_chung_nhan.php');
}
