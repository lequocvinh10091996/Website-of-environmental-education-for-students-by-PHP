<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Những Bài Học</a></li>
        </ol>
    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-content no-padding">
                ...
                $sql="select * from quan_ly_bai_hoc";
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $dong['id_quan_ly_kh']; ?></td>
                            <td><?php echo $dong['ten_khoa_hoc']; ?></td>
                            <td><?php echo $dong['id_quan_ly_bh']; ?></td>
                            <?php if($dong['lop_khoa_hoc']=='1'){ ?>
                                <td><img class="img-rounded" src="ajax/xu_ly/uploads/lop_1/<?php echo $dong['hinh_anh_bai_hoc']; ?>" alt=""><?php echo $dong['ten_bai_hoc']; ?></td>
                            <?php }?>
                            <?php if($dong['lop_khoa_hoc']=='2'){ ?>
                                <td><img class="img-rounded" src="ajax/xu_ly/uploads/lop_2/<?php echo $dong['hinh_anh_bai_hoc']; ?>" alt=""><?php echo $dong['ten_bai_hoc']; ?></td>
                            <?php }?>
                            <td><a href="index_v1.php#ajax/quan_ly_kiem_tra_bai_hoc.php?id_baihoc=<?php echo $dong['id_quan_ly_bh']; ?>&them_kt=them_bai_kiemtra">Thêm Bài Kiểm Tra</a></td>
                            <td><a href="index_v1.php#ajax/quan_ly_bai_hoc.php?id_baihoc=<?php echo $dong['id_quan_ly_bh']; ?>&sua=sua_baihoc">Sửa</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_bai_hoc.php?id_baihoc=<?php echo $dong['id_quan_ly_bh'] ?>&xoa=xoa_baihoc">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
