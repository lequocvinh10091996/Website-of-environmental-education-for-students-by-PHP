<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Khóa Học Của Giáo Viên</a></li>
        </ol>
            ...
            <div class="box-content no-padding">
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $dong['ten_giao_vien']; ?></td>
                            <td><?php echo $dong['ten_khoa_hoc']; ?></td>
                            <td><a href="index_v1.php#ajax/quan_ly_khoa_hoc_cua_giao_vien.php?id_khgv=<?php echo $dong['id_quan_ly_kh_cua_gv']; ?>&sua=sua_khgv">Sửa</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_khoa_hoc_cua_giao_vien.php?id_khgv=<?php echo $dong['id_quan_ly_kh_cua_gv'] ?>&xoa=xoa_khgv">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
