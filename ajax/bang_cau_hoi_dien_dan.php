<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Câu Hỏi Diễn Đàn</a></li>
        </ol>
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            ...
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_cau_hoi_dien_dan.php?id_chdd=<?php echo $dong['id_quan_ly_dd'] ?>&xoa=xoa_chdd">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
