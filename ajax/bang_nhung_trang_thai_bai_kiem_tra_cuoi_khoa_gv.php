<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Những Trạng Thái Bài Kiểm Tra Cuối Khóa</a></li>
        </ol>
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    <i class="fa fa-usd"></i>
                    <span>Những Trạng Thái Bài Kiểm Tra Cuối Khóa</span>
                </div>
                <div class="box-icons">
            ...
            <div class="box-content no-padding">
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    <tr>
                        <th>ID</th>
                        <th>Bài Kiểm Tra Khóa học</th>
                        <th>Tên Người Học</th>
                        <th>Điểm</th>
                        <th>Trạng Thái Bài Kiểm Tra</th>
                        <th>Xem Bài Kiểm Tra</th>
                        <th>Duyệt Bài Kiểm Tra</th>
                        <th>Xóa</th>
                        <!--							<th>Source</th>-->
                    ...
                    $sql1="select * from quan_ly_trang_thai_bai_kiem_tra_cuoi_khoa where ten_khoa_hoc='$ten_khoa_hoc_nguoi_dung'";
                    $run1=mysqli_query($conn,$sql1);
                    while($dong1=mysqli_fetch_array($run1)) {
                        ?>
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $dong1['ten_khoa_hoc']; ?></td>
                            <td><?php echo $dong1['ho_ten_dang_ky']; ?></td>
                            <td><?php echo $dong1['diem_kiem_tra_cuoi_khoa']; ?></td>
                            <td><?php echo $dong1['trang_thai']; ?></td>
                            <td><a href="quiz/index_khoa_kiem_tra_gv.php?id_khoahoc_kiemtra=<?php echo $dong1['id_quan_ly_kh'];?>">Xem</a></td>
                            <?php if ($dong1['trang_thai'] == 'hoàn thành') { ?>
                                <td>Bài Kiểm Tra Đã Kết Thúc</td>
                            <?php } ?>
                            <?php if ($dong1['trang_thai_duyet_kiem_tra'] == 'chưa duyệt') { ?>
                                <td>
                                    <a href="ajax/xu_ly/xu_ly_quan_ly_duyet_kiem_tra_khoa_hoc.php?id_khoahoc=<?php echo $dong1['id_quan_ly_kh'] ?>&duyet_tdk=<?php echo $dong1['ho_ten_dang_ky'] ?>">Duyệt</a>
                                </td>
                            <?php } ?>
                            <?php if ($dong1['trang_thai_duyet_kiem_tra'] == 'đã duyệt' && $dong1['trang_thai'] == 'chưa hoàn thành') { ?>
                                <td><a>Đã Duyệt</a></td>
                            <?php } ?>
                            <td>
                                <a href="ajax/xu_ly/xu_ly_quan_ly_trang_thai_bai_kiem_tra_cuoi_khoa.php?id_ktck=<?php echo $dong1['id_quan_ly_ktck'] ?>&xoa=xoa_ktck">Xóa</a>
                            </td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
