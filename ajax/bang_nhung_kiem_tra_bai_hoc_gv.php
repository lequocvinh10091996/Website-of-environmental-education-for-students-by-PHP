<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Những Những Bài Kiểm Tra Của Bài Học</a></li>
        </ol>
            ...
            <div class="box-content no-padding">
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while ($dong1=mysqli_fetch_array($run1)) {
                        $id_bai_hoc_nguoi_dung = $dong1['id_quan_ly_bh'];
                        $sql2 = "select * from quan_ly_kiem_tra_bai_hoc where id_quan_ly_bh='$id_bai_hoc_nguoi_dung'";
                        $run2 = mysqli_query($conn, $sql2);
                        while ($dong2 = mysqli_fetch_array($run2)) {
                            ?>
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td><?php echo $dong2['id_quan_ly_bh']; ?></td>
                                <td><?php echo $dong2['cau_hoi_1']; ?></td>
                                <td><?php echo $dong2['tra_loi_dung_ch1']; ?></td>
                                <td>
                                    <a href="index_v1_gv.php#ajax/quan_ly_kiem_tra_bai_hoc_gv.php?id_kiemtra=<?php echo $dong2['id_quan_ly_ktbh']; ?>&sua=sua_kiemtra">Sửa</a>
                                </td>
                                <td>
                                    <a href="ajax/xu_ly/xu_ly_quan_ly_kiem_tra_bai_hoc_gv.php?id_kiemtra=<?php echo $dong2['id_quan_ly_ktbh'] ?>&xoa=xoa_kiemtra">Xóa</a>
                                </td>
                            </tr>
                            <?php
                            $i++;
