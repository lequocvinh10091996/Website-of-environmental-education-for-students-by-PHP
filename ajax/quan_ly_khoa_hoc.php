		...
		<div class="box">
            ...
            <div class="box-content">
                    <?php if(isset($_GET['sua'])){?>
                        ...
                        <form action="ajax/xu_ly/xu_ly_quan_ly_khoa_hoc.php?id_khoahoc=<?php echo $dong['id_quan_ly_kh'];?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
