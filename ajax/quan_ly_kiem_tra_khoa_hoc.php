		...
		<div class="box">
            ...
            <?php if(isset($_GET['sua'])){?>
                ...
                <div class="box-content">
                    ...
                    <form action="ajax/xu_ly/xu_ly_quan_ly_kiem_tra_khoa_hoc.php?id_kiemtra_khoa=<?php echo $dong['id_quan_ly_ktkh']; ?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="form-styles">Hình câu hỏi</label>
                            <div class="col-sm-10">
            ...
            <?php }else{?>
                ...
                <div class="box-content">
                    ...
                    <form action="ajax/xu_ly/xu_ly_quan_ly_kiem_tra_khoa_hoc.php" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        <div class="form-group has-success has-feedback">
