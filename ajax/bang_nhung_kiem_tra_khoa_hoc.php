    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-content no-padding">
                ...
                $sql="select * from quan_ly_kiem_tra_khoa_hoc";
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            ...
                            <td><a href="index_v1.php#ajax/quan_ly_kiem_tra_khoa_hoc.php?id_kiemtra_khoa=<?php echo $dong['id_quan_ly_ktkh']; ?>&sua=sua_kiemtra_khoa">Sửa</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_kiem_tra_khoa_hoc.php?id_kiemtra_khoa=<?php echo $dong['id_quan_ly_ktkh'] ?>&xoa=xoa_kiemtra_khoa">Xóa</a></td>
                        </tr>
                        <?php
                        $i++;
                    }
