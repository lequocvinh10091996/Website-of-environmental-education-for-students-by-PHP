<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Những Người Đăng Ký Khóa Học</a></li>
        </ol>
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    <i class="fa fa-usd"></i>
                    <span>Những Người Đăng Ký Khóa Học</span>
                </div>
                <div class="box-icons">
                    <a href="download_excel_gv.php">
                        <i class="fas fa-arrow-circle-down"></i>
                    </a>
                    <a href="upload_excel_gv.php">
            ...
            <div class="box-content no-padding">
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    <tr>
                        ...
                        <th>Xem Trạng Thái Người Học</th>
                        <th>Xóa</th>
                        <!--							<th>Source</th>-->
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        $sql1="select * from quan_ly_nguoi_dang_ky_khoa_hoc where ten_khoa_hoc='$ten_khoa_hoc_nguoi_dung'";
                    ...
                    while($dong1=mysqli_fetch_array($run1)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index_v1_gv.php#ajax/bang_nhung_trang_thai_nguoi_hoc_khoa_hoc.php?xem_trangthai=<?php echo $dong1['ho_ten_dang_ky']; ?>&ten_khoa_hoc=<?php echo $dong1['ten_khoa_hoc'];?>">Xem</a>
                            </td>
                            <td>
                                <a href="ajax/xu_ly/xu_ly_quan_ly_nguoi_dang_ky_khoa_hoc_gv.php?id_ndkkh=<?php echo $dong1['id_quan_ly_ndkkh'] ?>&xoa=xoa_ndkkh&xoa_khoahoc=<?php echo $dong1['ten_khoa_hoc']; ?>&xoa_htdk=<?php echo $dong1['ho_ten_dang_ky']; ?>">Xóa</a>
                            </td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
