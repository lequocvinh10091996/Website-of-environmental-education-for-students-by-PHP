		...
		<div class="box">
            ...
            <?php if(isset($_GET['sua'])){?>
                ...
                <div class="box-content">
                    ...
                    <form action="ajax/xu_ly/xu_ly_quan_ly_bai_hoc_gv.php?id_baihoc=<?php echo $dong['id_quan_ly_bh']; ?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
...
<!--                                <label class="col-sm-2 control-label"><h4>--><?php //echo $dong['id_quan_ly_kh']; ?><!--</h4></label>-->
            ...
            <?php }else{?>
                ...
                <div class="box-content">
                    ...
                    <form action="ajax/xu_ly/xu_ly_quan_ly_bai_hoc_gv.php" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
