<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Tin Nhắn Email</a></li>
        </ol>
    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-content no-padding">
                ...
                $sql="select * from quan_ly_gui_email";
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $dong['ten_gui_email']; ?></td>
                            <td><?php echo $dong['email_gui_email']; ?></td>
                            <td><?php echo $dong['tin_nhan_gui_email']; ?></td>
                            <td><a href="https://mail.google.com/mail/u/0/?tab=wm">Trả Lời</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_gui_email.php?id_gemail=<?php echo $dong['id_quan_ly_gemail'] ?>&xoa=xoa_gemail">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
