	...
	<div id="dashboard_tabs" class="col-xs-12 col-sm-10">
		...
		<div id="dashboard-overview" class="row" style="visibility: visible; position: relative;">
            <div id="ow-marketplace" class="col-sm-12 col-md-6">
                <h4 class="page-header">Những Học Sinh Thuộc Trường Đăng Ký Khóa Học</h4>
                <table id="ticker-table" class="table m-table table-bordered table-hover table-heading">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            <td class="m-ticker"><b><?php echo $dong['ho_ten_dang_ky'];?></b></td>
                            <td class="m-ticker"><b><?php echo $dong1['truong_dang_ky'];?></b></td>
                            <td class="m-ticker"><b><?php echo $dong['ten_khoa_hoc'];?></b></td>
                        </tr>
                        <?php
                        $i++;
                    }
			...
			<div id="ow-marketplace" class="col-sm-12 col-md-6">
				...
				<!--</div>-->
				<h4 class="page-header">Số Lượng Người Đăng Ký Những Khóa Học</h4>
				<table id="ticker-table" class="table m-table table-bordered table-hover table-heading">
					<thead>
						<tr>
							<th>Tên Khóa Học</th>
                    ...
                    ?>
						...
						<tr>
							<td class="m-ticker"><b><?php echo $dong['ten_khoa_hoc'];?></b></td>
							<td class="m-price"><?php echo $dong1[0];?></td>
						</tr>
                        <?php
                        $i++;
                    }
