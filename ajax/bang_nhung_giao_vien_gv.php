<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Thông Tin Bản Thân</a></li>
        </ol>
    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-content no-padding">
                ...
                $sql="select * from quan_ly_giao_vien where ten_giao_vien='$ten_nguoi_dung'";
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            ...
                            <td><a href="index_v1.php#ajax/quan_ly_giao_vien_gv.php?id_giaovien=<?php echo $dong['id_quan_ly_gv']; ?>&sua=sua_giaovien">Sửa</a></td>
                        </tr>
                        <?php
                        $i++;
                    }
