<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Trạng Thái Người Học Khóa Học</a></li>
        </ol>
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    <i class="fa fa-usd"></i>
                    <span>Trạng Thái Người Học Khóa Học</span>
                </div>
                <div class="box-icons">
            ...
            <div class="box-content no-padding">
                <?php
                if(isset($_GET['xem_trangthai'])){
                    $ho_ten_dang_ky=$_GET['xem_trangthai'];
                    $ten_khoa_hoc=$_GET['ten_khoa_hoc'];
                    include ('xu_ly/config/config.php');
                    $sql="select * from quan_ly_trang_thai_nguoi_hoc_khoa_hoc where ho_ten_dang_ky='$ho_ten_dang_ky' and ten_khoa_hoc='$ten_khoa_hoc'";
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            ...
                            <td><?php echo $dong['ten_bai_hoc']; ?></td>
