...
<!--                    </a>-->
            ...
            <div class="box-content no-padding">
                ...
                $sql="select * from quan_ly_nguoi_dang_ky_khoa_hoc";
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            ...
                            <td><a href="index_v1.php#ajax/bang_nhung_trang_thai_nguoi_hoc_khoa_hoc.php?xem_trangthai=<?php echo $dong['ho_ten_dang_ky'];?>&ten_khoa_hoc=<?php echo $dong['ten_khoa_hoc'];?>">Xem</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_nguoi_dang_ky_khoa_hoc.php?id_ndkkh=<?php echo $dong['id_quan_ly_ndkkh'] ?>&xoa=xoa_ndkkh&xoa_khoahoc=<?php echo $dong['ten_khoa_hoc']; ?>&xoa_htdk=<?php echo $dong['ho_ten_dang_ky']; ?>">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
