		...
		<div class="box">
            ...
            <?php if(isset($_GET['sua'])){?>
                ...
                <div class="box-content">
                    ...
                    <form action="ajax/xu_ly/xu_ly_quan_ly_kiem_tra_bai_hoc_gv.php?id_kiemtra=<?php echo $dong['id_quan_ly_ktbh']; ?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
...
<!--                        </div>-->
            ...
            <?php }else{?>
                ...
                <div class="box-content">
                    ...
                    <form action="ajax/xu_ly/xu_ly_quan_ly_kiem_tra_bai_hoc_gv.php" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        <div class="form-group has-success has-feedback">
                            <label class="col-sm-2 control-label"><h4>Mã Bài Học</h4></label> <label class="col-sm-2 control-label"><h4><?php echo $dong['id_quan_ly_bh']; ?></h4></label>
                        </div>
                        <div class="form-group">
