<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Những Bài Học Của Giáo Viên</a></li>
        </ol>
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    <i class="fa fa-usd"></i>
                    <span>Những Bài Học Của Giáo Viên</span>
                </div>
                <div class="box-icons">
            ...
            <div class="box-content no-padding">
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        $sql1="select * from quan_ly_bai_hoc where ten_khoa_hoc='$ten_khoa_hoc_nguoi_dung'";
                    ...
                    while($dong1=mysqli_fetch_array($run1)){
                        ...
                        <tr>
                            ...
                            <td><img class="img-rounded" src="ajax/xu_ly/uploads/lop_<?php echo $dong1['lop_khoa_hoc']; ?>/<?php echo $dong1['hinh_anh_bai_hoc']; ?>" alt=""><?php echo $dong1['ten_bai_hoc']; ?></td>
                            <td><a href="index_v1_gv.php#ajax/quan_ly_kiem_tra_bai_hoc_gv.php?id_baihoc=<?php echo $dong1['id_quan_ly_bh']; ?>&them_kt=them_bai_kiemtra">Thêm Bài Kiểm Tra</a></td>
                            <td><a href="index_v1_gv.php#ajax/quan_ly_bai_hoc_gv.php?id_baihoc=<?php echo $dong1['id_quan_ly_bh']; ?>&sua=sua_baihoc">Sửa</a></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_bai_hoc_gv.php?id_baihoc=<?php echo $dong1['id_quan_ly_bh'] ?>&xoa=xoa_baihoc">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
