<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Bảng</a></li>
            <li><a href="#">Bảng Những Chứng Nhận</a></li>
        </ol>
                ...
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    while($dong=mysqli_fetch_array($run)){
                        ...
                        <tr>
                            ...
                            <td><?php echo $dong['diem_cn']; ?></td>
                            <td><?php echo $dong['thoi_gian_cn']; ?></td>
                            <td><a href="ajax/xu_ly/xu_ly_quan_ly_chung_nhan.php?id_chungnhan=<?php echo $dong['id_quan_ly_cn'] ?>&xoa=xoa_chungnhan">Xóa</a></td>
                            <!--							<td>telecom</td>-->
                            <!--							<td>Mexico</td>-->
                        </tr>
                        <?php
