...
<div id="page-wrap">
    ...
    <script>
        ...
        function demNguoc() {
            number_khoa=number_khoa-1;
            if(number_khoa!=0){
                document.getElementById("textBox").value=number_khoa;
                setTimeout("demNguoc()",1000);
            }else{
                window.location.href="grade_khoa_kiem_tra.php?ten_kh=<?php echo $dong['ten_khoa_hoc'];?>&id_khoahoc_kiemtra=<?php echo $dong['id_quan_ly_kh'];?>&het_tg=1";
            }
        }
