<?php
if(isset($_GET['xoa_dlc'])){
    include ('modules/xu_ly/config/config.php');
    $id_khoahoc_cu=$_GET['xoa_dlc'];
    $ten_dang_ky_khc=$_SESSION['ho_ten_dang_ky'];
    //xoa đăng ký
    $sql="delete from quan_ly_nguoi_dang_ky_khoa_hoc where id_quan_ly_kh='$id_khoahoc_cu' and ho_ten_dang_ky='$ten_dang_ky_khc'";
    mysqli_query($conn,$sql);
    //xóa trạng thái bài học
    $sql1="select * from quan_ly_khoa_hoc where id_quan_ly_kh='$id_khoahoc_cu'";
    $run1=mysqli_query($conn,$sql1);
    $dong1=mysqli_fetch_array($run1);
    $ten_khoahoc_cu=$dong1['ten_khoa_hoc'];
    $sql="delete from quan_ly_trang_thai_nguoi_hoc_khoa_hoc where ten_khoa_hoc='$ten_khoahoc_cu' and ho_ten_dang_ky='$ten_dang_ky_khc'";
    mysqli_query($conn,$sql);
    $sql="delete from quan_ly_trang_thai_bai_kiem_tra_cuoi_khoa where id_quan_ly_kh='$id_khoahoc_cu' and ho_ten_dang_ky='$ten_dang_ky_khc'";
    mysqli_query($conn,$sql);
}
?>
<header class="header">
                    ...
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        ...
                        <nav class="main_nav_contaner ml-auto">
                            <ul class="main_nav">
                                ...
                                <li><a href="dien_dan.php">Diễn Đàn</a></li>
            ...
            <div class="row">
                <div class="col">
                    <div class="header_search_content d-flex flex-row align-items-center justify-content-end">
                        <form action="#" class="header_search_form" method="post" enctype="multipart/form-data">
                            <input type="search" class="search_input" placeholder="Tìm Kiếm" required="required" name="tim_kiem_khoa_hoc">
                            <button class="header_search_button d-flex flex-column align-items-center justify-content-center" type="submit" name="tim_kiem">
