                        ...
                        <div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
                            <ul class="top_bar_contact_list">
                                <li><div class="question">Chào Mừng Bạn Đến Với Website Giáo Dục Môi Trường !
                                        ...
                                        <?php }?>
                                        <?php session_start();?>
                                        <?php if(isset($_SESSION['nap_tien'])){
                                            if($_SESSION['nap_tien']=='chưa nạp tiền'){?>
                                                <script>alert('Xin vui lòng nạp thêm tiền để bắt đầu hoc !')</script>
                                                <?php
                                                unset($_SESSION['nap_tien']);
                                            }
                                        }
                                        if(isset($_SESSION['nap_tien_sai'])){?>
                                                <script>alert('Nhập sai mã nạp tiền !')</script>
                                                <?php
                                                unset($_SESSION['nap_tien_sai']);
                                        }
                                        ?>
                                        ...
                                        <?php if(isset($_SESSION['dang_nhap'])){?>
                                            <?php if($_SESSION['dang_nhap']=='thanh_cong'){?>
                                        ...
                                        <?php } ?>
                                        <?php if($_SESSION['dang_nhap']=='that_bai'){?>
                                            <script>alert('Bạn Đã Đăng Nhập Thất bại !')</script>

                                            <?php unset($_SESSION['dang_nhap']);
                                        } ?>
                                        <?php } ?>
                                    </div></li>
                                <!--                            <li>-->
