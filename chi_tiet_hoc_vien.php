...
<html lang="en">
<head>
<title>Website Moi Truong</title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	<!-- Header -->
    <?php  include ('modules/chi_tiet_hoc_vien/header.php'); ?>
	<!-- Menu -->
	...
	<!-- Home -->
    <?php include ('modules/chi_tiet_hoc_vien/home.php'); ?>
	<!-- Features -->
	...
	<!-- Popular Courses -->
<!--    --><?php //include ('modules/index/popular_courses.php'); ?>
	<!-- Counter -->
	...
	<!-- Team -->
<!--    --><?php //include ('modules/index/team.php'); ?>
	<!-- Latest News -->
    <?php include ('modules/chi_tiet_hoc_vien/news.php'); ?>
	<!-- Newsletter -->
