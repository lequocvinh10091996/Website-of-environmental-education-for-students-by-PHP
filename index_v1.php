			...
			<ul class="nav main-menu">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a class="ajax-link" href="ajax/bang_nhung_khoa_hoc.php">Bảng Các Khóa Học</a></li>
                        <li><a class="ajax-link" href="ajax/bang_nhung_bai_hoc.php">Bảng Các Bài Học</a></li>
                        <li><a class="ajax-link" href="ajax/bang_nhung_giao_vien.php">Bảng Các Giáo Viên</a></li>
                        <li><a class="ajax-link" href="ajax/bang_dang_ky.php">Bảng Người Dùng Đăng Ký</a></li>
                        <li><a class="ajax-link" href="ajax/bang_nhung_tai_khoan.php">Bảng Những Tài Khoản</a></li>
                        <li><a class="ajax-link" href="ajax/bang_khoa_hoc_cua_giao_vien.php">Khóa Học Của Giáo Viên</a></li>
                        <li><a class="ajax-link" href="ajax/bang_tin_nhan_email.php">Bảng Tin Nhắn Email</a></li>
                        <li><a class="ajax-link" href="ajax/bang_cau_hoi_dien_dan.php">Bảng Câu Hỏi Diễn Đàn</a></li>
                        <li><a class="ajax-link" href="ajax/bang_cau_tra_loi_dien_dan.php">Bảng Câu Trả Lời Diễn Đàn</a></li>
                        <li><a class="ajax-link" href="ajax/bang_nhung_chung_nhan.php">Bảng Những Chứng Nhận</a></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
                        ...
                        <li><a class="ajax-link" href="ajax/quan_ly_khoa_hoc_cua_giao_vien.php">Khóa Học Của Giáo Viên</a></li>
...
<!--						<li><a class="ajax-link" href="ajax/forms_file_uploader.html">File Uploader</a></li>-->
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
                        <li><a class="ajax-link" href="ajax/bang_nhung_nguoi_dang_ky_khoa_hoc.php">Người Đăng Ký Khóa Học</a></li>
                        <li><a class="ajax-link" href="ajax/bang_nhung_trang_thai_bai_kiem_tra_cuoi_khoa.php">Trạng Thái Kiểm Tra Khóa</a></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
                        <li><a class="ajax-link" href="ajax/bang_nhung_kiem_tra_bai_hoc.php">Bài Kiểm Tra Bài Học</a></li>
                        <li><a class="ajax-link" href="ajax/bang_nhung_kiem_tra_khoa_hoc.php">Bài Kiểm Tra Khóa Học</a></li>
...
<script src="js_manager/devoops.js"></script>
<?php }else{?>
